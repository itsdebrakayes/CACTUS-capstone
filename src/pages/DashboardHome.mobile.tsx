...
export default function DashboardHome() {
  ...
  return (
    <AppLayout activeTab="dashboard">
      {/* Header */}
      <div className="glass-panel rounded-none border-l-0 border-r-0 border-t-0 px-4 pt-12 pb-4 sticky top-0 z-10">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            <div className="w-10 h-10 rounded-2xl cactus-honey-grad flex items-center justify-center text-white font-black text-sm shadow-md shadow-amber-500/30">
              {displayName.charAt(0).toUpperCase()}
            </div>
            <div>
              <p className="font-black text-[hsl(var(--cactus-ink))] text-base leading-none tracking-tight">CACTUS</p>
              <p className="text-[10px] text-slate-500 mt-1 uppercase tracking-widest">Campus OS</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <button className="w-10 h-10 rounded-2xl bg-white/70 border border-white/60 flex items-center justify-center text-slate-600">
              <Search className="w-4 h-4" />
            </button>
            <button className="w-10 h-10 rounded-2xl bg-white/70 border border-white/60 flex items-center justify-center text-slate-600 relative">
              <Bell className="w-4 h-4" />
              {activeAlerts.length > 0 && (
                <span className="absolute top-2 right-2 w-2 h-2 bg-[hsl(var(--cactus-rose))] rounded-full" />
              )}
            </button>
          </div>
        </div>
      ...
      <div className="px-4 pt-5 pb-3">
        <h1 className="text-3xl font-black text-[hsl(var(--cactus-ink))] leading-tight tracking-tight">
